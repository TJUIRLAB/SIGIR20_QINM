...
flags.DEFINE_float("l2_reg_lambda", 0.0000016, "L2 regularizaion lambda (default: 0.0)")
flags.DEFINE_float("learning_rate", 0.000001, "learn rate( default: 0.0)")
...
flags.DEFINE_string("loss","list_wise","loss function (default:point_wise)")
